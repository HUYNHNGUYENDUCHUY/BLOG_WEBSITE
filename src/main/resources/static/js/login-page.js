        ...
        $.ajax({
            ...
            success:function (value){
                if(value == "false"){
                    ...
                    // Hide all pages
                    $("#about-page, #home-page, #contact-page, #login-header,#manage-post,#create-post").css("display", "none");
                    ...
                    $(clickedElement).not('#create-new-post,#manage-post-control').css({"background-color":"#EFF4FA","color":"#63A4D9"});
